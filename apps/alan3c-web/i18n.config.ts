  ...
  messages: {
    en: {
      ...
      bibliography: {
        ...
        domesticMagazineArticles: 'Domestic Magazine Articles',
    ...
    zh: {
      ...
      bibliography: {
        internationalConferencePapers: '國際會議論文',
        internationalJournalPapers: '國際期刊論文',
        bookChapters: '書籍章節',
        localJournalPapers: '本地期刊論文',
        domesticMagazineArticles: '國內雜誌文章',
        technicalReports: '技術報告',
        guestEditorial: '客座社論',
        localConferencePapers: '本地會議論文',
        authoredBooks: '圖書著作',
        submittedPapers: '已提交論文',
      },
      authoredBooks: {
        coAuthor: '合著者',
      },
